...
RUN set -ex; \
    ...
    if [ "$ODOO_VER" = "8.0" ]; then wget https://github.com/odoo/odoo/commit/0baf5f9916a7fde4d0d4fa97c1ee70059ae886fb.patch -o server/allow_root_user.patch; cd /opt/odoo/server; patch -p1 < allow_root_user.patch; fi
